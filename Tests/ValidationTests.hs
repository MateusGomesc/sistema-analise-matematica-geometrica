...
testeValidarProjetoValido =
  let projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Válido",
            tipoProjeto = Civil,
            statusProjeto = Planejamento,
            responsaveis = [],
            tarefas = [],
            materiais = [Material "Concreto" 2400 30e6 350 100],
            calculos = [],
            funcoes = [],
            dataInicio = fromGregorian 2025 1 1,
            dataFim = Nothing,
            orcamento = 50000
          }
...
testeValidarProjetoSemMateriais =
  let projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Sem Materiais",
            tipoProjeto = Civil,
            statusProjeto = EmDesenvolvimento,
            responsaveis = [],
            tarefas = [],
            materiais = [],
            calculos = [],
  ...
  let projeto =
        Projeto
          { idProjeto = 1,
            ...
            calculos = [],
            funcoes = [],
            dataInicio = fromGregorian 2025 6 1,
            dataFim = Just (fromGregorian 2025 1 1),
            orcamento = 50000
          }
      erros = validarProjeto projeto
   in not (null erros) -- data fim anterior à data início
...
testeValidarProjetoCompleto =
  let material1 = Material "Concreto" 2400 30e6 350 100
      ...
      calculo1 = CalculoMat "Momento Inércia" [0.3, 0.5] 0.003125 "m^4" "I=bh³/12"
      funcao1 = Funcao (Linear 2 3) "f(x) = 2x + 3"
      projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Completo",
            tipoProjeto = Civil,
            statusProjeto = EmDesenvolvimento,
            responsaveis = [],
            tarefas = [],
            ...
            funcoes = [funcao1],
            dataInicio = fromGregorian 2025 1 1,
            dataFim = Just (fromGregorian 2025 12 31),
            orcamento = 100000
          }
      erros = validarProjeto projeto
   in null erros
...
testeCalcularCustoTotalQuantidadeZero =
  let material1 = Material "Concreto" 2400 30e6 350 0 -- 350 * 0 = 0
      material2 = Material "Aço" 7850 500e6 4.50 100 -- 4.50 * 100 = 450
      projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto",
...
testeCalcularCustoTotalValoresGrandes =
  let material = Material "Caro" 1000 1e6 1000000 1000 -- 1M * 1000 = 1B
      projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Bilionário",
            tipoProjeto = Civil,
            statusProjeto = Planejamento,
            responsaveis = [],
            tarefas = [],
...
-- =================================
-- TESTES PARA GERAR RELATORIO PROJETO
-- =================================
      ...
      projeto =
        Projeto
          { idProjeto = 1,
            ...
            dataFim = Just (fromGregorian 2025 12 1),
            orcamento = 100000
          }
...
testeGerarRelatorioProjetoSemDataFim =
  let projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Indefinido",
            tipoProjeto = Mecanica,
            statusProjeto = EmRevisao,
            responsaveis = [],
            tarefas = [],
            materiais = [Material "Metal" 7000 200e6 5 100],
            calculos = [],
            funcoes = [],
            dataInicio = fromGregorian 2025 1 1,
            dataFim = Nothing,
...
testeGerarRelatorioProjetoConcluido =
  let projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Finalizado",
            tipoProjeto = Eletrica,
            statusProjeto = Concluido,
            responsaveis = [],
            tarefas = [],
            materiais = [Material "Cabo" 8900 100e9 2 1000],
            calculos = [],
            funcoes = [],
            dataInicio = fromGregorian 2025 1 1,
            dataFim = Just (fromGregorian 2025 6 1),
            orcamento = 25000
          }
      relatorio = gerarRelatorioProjeto projeto
   in length relatorio >= 5
...
testeGerarRelatorioProjetoMuitosMateriais =
  let materiais =
      ...
      projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Rico em Materiais",
            tipoProjeto = Estrutural,
            statusProjeto = Planejamento,
            responsaveis = [],
            tarefas = [],
            materiais = materiais,
...
testeGerarRelatorioProjetoComCalculos =
  let calculos =
        [ CalculoMat "Área Total" [100, 200] 20000 "m²" "A = l * w",
          CalculoMat "Volume" [20000, 0.15] 3000 "m³" "V = A * h",
          CalculoMat "Massa" [3000, 2400] 7200000 "kg" "m = V * ρ"
        ]
      projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto com Cálculos",
            tipoProjeto = Civil,
            statusProjeto = Planejamento,
            responsaveis = [],
            tarefas = [],
            materiais = [Material "Concreto" 2400 30e6 350 200],
            calculos = calculos,
            funcoes = [],
            dataInicio = fromGregorian 2025 1 1,
            dataFim = Nothing,
  ...
  let projeto =
        Projeto
          { idProjeto = 1,
            ...
            responsaveis = [],
            tarefas = [],
            materiais = [Material "Ouro" 19300 200e9 50000 20],
            calculos = [],
            funcoes = [],
            dataInicio = fromGregorian 2025 1 1,
            dataFim = Nothing,
...
testeGerarRelatorioProjetoTiposVariados =
  let projetoCivil = Projeto 1 "Civil" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000
      projetoMecanica = Projeto 2 "Mecânica" Mecanica EmDesenvolvimento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000
      projetoEletrica = Projeto 3 "Elétrica" Eletrica EmRevisao [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 3000
      projetoEstrutural = Projeto 4 "Estrutural" Estrutural Concluido [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 4000
...
testeGerarRelatorioProjetoFormatacao =
  let projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Teste Formatação",
            tipoProjeto = Civil,
            statusProjeto = Planejamento,
            responsaveis = [],
            tarefas = [],
            materiais = [Material "Teste" 1000 1e6 100 10],
            calculos = [],
            funcoes = [],
            dataInicio = fromGregorian 2025 1 1,
            dataFim = Nothing,
...
testeGerarRelatorioProjetoComFuncoes =
  let funcoes =
        [ Funcao (Linear 2 3) "Função linear: f(x) = 2x + 3",
          Funcao (Quadratica 1 (-2) 1) "Parábola: f(x) = x² - 2x + 1",
          Funcao (Trigonometrica Seno 1 0) "Senoide: f(x) = sin(x)"
        ]
      projeto =
        Projeto
          { idProjeto = 1,
            nomeProjeto = "Projeto Matemático",
            tipoProjeto = Civil,
            statusProjeto = Planejamento,
            responsaveis = [],
            tarefas = [],
...
testeCompararProjetosIguais =
  let projeto =
   ...
   in isInfixOf "iguais" resultado
        || isInfixOf "mesmo" resultado
...
testeCompararProjetosDiferentesTipo =
  let projeto1 = Projeto 1 "Projeto Civil" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 50000
      projeto2 = Projeto 2 "Projeto Mecânico" Mecanica EmDesenvolvimento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 60000
      resultado = compararProjetos projeto1 projeto2
   in isInfixOf "Civil" resultado
        && isInfixOf "Mecanica" resultado
        && length resultado > 50
  where
    isInfixOf xs ys = any (isPrefixOf xs) (tails ys)
    isPrefixOf [] _ = True
...
testeCompararProjetosOrcamentoDiferente =
  let projeto1 = Projeto 1 "Barato" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 10000
      projeto2 = Projeto 2 "Caro" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 100000
      resultado = compararProjetos projeto1 projeto2
...
testeCompararProjetosStatusDiferente =
  let projeto1 = Projeto 1 "Em Planejamento" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 50000
      projeto2 = Projeto 2 "Concluído" Civil Concluido [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 6 1)) 50000
      resultado = compararProjetos projeto1 projeto2
...
testeCompararProjetosDatasDiferentes =
  let projeto1 = Projeto 1 "Antigo" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 50000
      projeto2 = Projeto 2 "Recente" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 6 1) Nothing 50000
      resultado = compararProjetos projeto1 projeto2
...
testeCompararProjetosComplexidade =
  let material1 = Material "Concreto" 2400 30e6 350 100
      ...
      calculo1 = CalculoMat "Área" [10, 20] 200 "m²" "A = b * h"
      funcao1 = Funcao (Linear 2 3) "f(x) = 2x + 3"
      projetoSimples = Projeto 1 "Simples" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 10000
      projetoComplexo =
        Projeto
          { idProjeto = 2,
            nomeProjeto = "Complexo",
            tipoProjeto = Civil,
            statusProjeto = Planejamento,
            responsaveis = [],
            tarefas = [],
...
testeCompararProjetosNomesSimilares =
  let projeto1 = Projeto 1 "Ponte do Rio A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 50000
      projeto2 = Projeto 2 "Ponte do Rio B" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 55000
      resultado = compararProjetos projeto1 projeto2
...
testeCompararProjetosComDataFim =
  let projeto1 = Projeto 1 "Com Fim" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 12 1)) 50000
      projeto2 = Projeto 2 "Sem Fim" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 50000
      resultado = compararProjetos projeto1 projeto2
   in isInfixOf "fim" resultado
        || isInfixOf "conclus" resultado
...
testeCompararProjetosFormatacao =
  let projeto1 = Projeto 1 "A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000
      projeto2 = Projeto 2 "B" Mecanica Concluido [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000
      resultado = compararProjetos projeto1 projeto2
   in length resultado > 20
        && (any (== ':') resultado || any (== '=') resultado || any (== '-') resultado)

-- =================================
-- TESTES PARA ESTATÍSTICAS BÁSICAS
-- =================================
...
testeContarPorTipoUnico =
  let projetos =
        [ Projeto i ("P" ++ show i) Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000
          | i <- [1 .. 5]
        ]
...
testeContarPorTipoVario =
  let projetos =
        [ Projeto 1 "A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000,
          Projeto 2 "B" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000,
          Projeto 3 "C" Mecanica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 3000,
          Projeto 4 "D" Eletrica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 4000
        ]
      resultado = contarPorTipo projetos
...
testeContarPorTipoTodosIguais =
  let projetos = replicate 10 (Projeto 1 "Teste" Estrutural Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000)
      resultado = contarPorTipo projetos
...
testeContarPorTipoCompleto =
  let projetos =
        [ Projeto 1 "Civil1" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000,
          Projeto 2 "Civil2" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000,
          Projeto 3 "Mec1" Mecanica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 3000,
          Projeto 4 "Mec2" Mecanica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 4000,
          Projeto 5 "Mec3" Mecanica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 5000,
          Projeto 6 "Elet1" Eletrica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 6000,
          Projeto 7 "Estr1" Estrutural Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 7000
        ]
      resultado = contarPorTipo projetos
...
testeContarPorTipoOrdem =
  let projetos =
        [ Projeto 1 "Z" Estrutural Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000,
          Projeto 2 "A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000,
          Projeto 3 "M" Mecanica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 3000,
          Projeto 4 "E" Eletrica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 4000
        ]
      resultado = contarPorTipo projetos
...
testeContarPorTipoUmDeCadaTipo =
  let projetos =
        [ Projeto 1 "Civil" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000,
          Projeto 2 "Mecanica" Mecanica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000,
          Projeto 3 "Eletrica" Eletrica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 3000,
          Projeto 4 "Estrutural" Estrutural Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 4000
        ]
      resultado = contarPorTipo projetos
...
testeContarPorTipoDesbalanceado =
  let projetosCivil = replicate 10 (Projeto 1 "Civil" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000)
      projetoMecanica =
        [ Projeto 11 "Mecanica" Mecanica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000
        ]
...
testeContarPorTipoMuitosProjetos =
  let projetos =
        [ Projeto i ("P" ++ show i) (tiposPorId i) Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing (fromIntegral i * 1000)
          | i <- [1 .. 100]
        ]
      resultado = contarPorTipo projetos
...
testeContarPorTipoStatusVariado =
  let projetos =
        [ Projeto 1 "A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000,
          Projeto 2 "B" Civil Concluido [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 2000,
          Projeto 3 "C" Civil Cancelado [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 3000
        ]
      resultado = contarPorTipo projetos
...
testeProjetosEmAtrasoNenhum =
  let projetos =
        [ Projeto 1 "A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 12 1)) 100,
          Projeto 2 "B" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 2 1) (Just (fromGregorian 2025 12 1)) 200
        ]
...
testeProjetosEmAtrasoTodos =
  let projetos =
        [ Projeto 1 "A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 3 1)) 1000,
          Projeto 2 "B" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 2 1) (Just (fromGregorian 2025 4 1)) 2000
        ]
...
testeProjetosEmAtrasoAlguns =
  let projetos =
        [ Projeto 1 "Atrasado" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 3 1)) 1000,
          Projeto 2 "No Prazo" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 2 1) (Just (fromGregorian 2025 12 1)) 200,
          Projeto 3 "Também Atrasado" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 4 1)) 3000
        ]
...
testeProjetosEmAtrasoSemDataFim =
  let projetos =
        [ Projeto 1 "Sem Prazo" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) Nothing 1000,
          Projeto 2 "Com Prazo Vencido" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 2 1) (Just (fromGregorian 2025 3 1)) 2000
        ]
      dataAtual = fromGregorian 2025 6 1
      resultado = projetosEmAtraso projetos dataAtual
...
testeProjetosEmAtrasoPrazoHoje =
  let projetos =
        [ Projeto 1 "Prazo Hoje" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 6 1)) 1000
        ]
...
testeProjetosEmAtrasoPrazoAmanha =
  let projetos =
        [ Projeto 1 "Prazo Amanhã" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 6 2)) 1000
        ]
...
testeProjetosEmAtrasoProjetosConcluidos =
  let projetos =
        [ Projeto 1 "Concluído no Prazo" Civil Concluido [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 3 1)) 1000,
          Projeto 2 "Concluído Atrasado" Civil Concluido [] [] [] [] [] (fromGregorian 2025 2 1) (Just (fromGregorian 2025 4 1)) 2000,
...
testeProjetosEmAtrasoOrdenacao =
  let projetos =
        [ Projeto 3 "C" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 5 1)) 3000,
          Projeto 1 "A" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 3 1)) 1000,
          Projeto 2 "B" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 4 1)) 2000
        ]
      dataAtual = fromGregorian 2025 6 1
      resultado = projetosEmAtraso projetos dataAtual
...
testeProjetosEmAtrasoTiposVariados =
  let projetos =
        [ Projeto 1 "Civil Atrasado" Civil Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 3 1)) 1000,
          Projeto 2 "Mecânica Atrasada" Mecanica EmDesenvolvimento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 4 1)) 2000,
          Projeto 3 "Elétrica No Prazo" Eletrica Planejamento [] [] [] [] [] (fromGregorian 2025 1 1) (Just (fromGregorian 2025 12 1)) 300
        ]
      dataAtual = fromGregorian 2025 6 1
      resultado = projetosEmAtraso projetos dataAtual
...
executarTestesEspecialista5 = do
  ...
  putStrLn $ "Orçamento alto: " ++ show testeGerarRelatorioProjetoOrcamentoAlto
